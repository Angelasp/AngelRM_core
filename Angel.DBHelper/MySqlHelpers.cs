...
namespace Angel.DBHelper
{
        ...
        public static string connectionString = ConnectionString.GetConfig("ConnectionStrings", "MySqlconn");
      // public static string connectionString = "Data Source=localhost;Database=angelmvc;User ID=root;Password=admin;pooling=true;port=3306;sslmode=none;CharSet=utf8;";
