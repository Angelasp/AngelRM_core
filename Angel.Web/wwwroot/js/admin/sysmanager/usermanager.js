...
$(function () {
    ...
    //查询所省份城市列表
    com.server.get('/api/dataapi/get/1', function (resultData) {
    ...
    //查询所处室列表
    com.server.get('/api/dataapi/get/4', function (resultData) {
        var data = resultData.data;
        if (data != null) {
            var dhtml = '';
            $.each(data, function (i) {
    ...
    //查询所有角色列表
    com.server.get('/api/roleapi/get', function (resultData) {
        var data = resultData.data;
        if (data != null) {
            var dhtml = '';
            $.each(data, function (i) {
        ...
        if (data != null) {
            if (ptype == "add") {
                if (data.code == 1) {
                    ...
                    com.server.post(actionurl, JSON.stringify(postlist), function (resultData) {
                        var data = JSON.parse(resultData.data);
